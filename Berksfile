...
# ELK stack required cookbooks
load_cookbook 'elkstack',      git: 'https://github.com/rackspace-cookbooks/elkstack'
load_cookbook 'elasticsearch', git: 'https://github.com/racker/cookbook-elasticsearch'
load_cookbook 'logstash',      git: 'https://github.com/racker/chef-logstash'
load_cookbook 'kibana',        git: 'https://github.com/lusis/chef-kibana'
load_cookbook 'openssl',       git: 'https://github.com/racker/openssl'

#load_cookbook 'elasticsearch', git: 'https://github.com/elasticsearch/cookbook-elasticsearch.git'
#load_cookbook 'logstash',      git: 'https://github.com/lusis/chef-logstash.git'
#load_cookbook 'kibana',        git: 'https://github.com/lusis/chef-kibana.git'
